...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="<?php echo e(site_url('logout')); ?>">Sign out</a>
    </div>
  </div>
</header>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link
            " aria-current="page" href="<?php echo e(site_url('backend/dashboard')); ?>">
              <span data-feather="home" class="align-text-bottom"></span>
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(site_url('backend/dashboard/table')); ?>">
              <span data-feather="file" class="align-text-bottom"></span>
              Table
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(site_url('backend/User/profile')); ?>">
...
<?php /**PATH D:\fakhri web\appblog\application\views/template/backend/theme.blade.php ENDPATH**/ ?>